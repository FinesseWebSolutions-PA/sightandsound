...
export const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    target: '[data-tour="set-tabs"]',
    quick: true,
    body: "Tasks show the work on this set, who owns it and where progress is blocked.",
    points: [
      "Open a task for its details and related conversation.",
  ...
  },
  {
    ...
    route: "schedule",
    target: '[data-tour="set-tabs"]',
    body: "The schedule shows planned work and how dates relate. A change to an earlier build can affect subsequent work.",
    points: [
      "Check the committed dates, forecast and dependencies rather than relying on a status badge alone.",
